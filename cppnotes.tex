...
minted language=cpp,
listing only,
minted options app={linenos, numbersep=5pt, escapeinside=||, tabsize=4},
...
\newcommand{\daxfile}{\faIcon*[regular]{file}}
\newcommand{\daxfolder}{\faIcon[regular]{folder}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
